...
<td><a href="${base}/module/pams/gxgl/rep/wwcqk/bm/rep_main_wwcqk.action?internal=${awfbzs.internal}&begindate=${arg.begindate}&enddate=${arg.enddate}"  target="_blank">${awfbzs.cname}</a></td>
<td>${awfbzs.num}</td>
<td>${azczxzs.num}</td>
<td>${acszxzs.num}</td>
<td>${ayzxjdzs.num}</td>
