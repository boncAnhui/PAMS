...
<h2><span class="title tab_zxqk">信息共享未完成情况(公司)指标统计</span><span class="more"></span></h2>
...
{
	page_load_table("${base}/module/pams/gxgl/rep/zxqk/gs/rep_tab_zxqk.action", "zxqk", 0, new Array(), new Array());
}
