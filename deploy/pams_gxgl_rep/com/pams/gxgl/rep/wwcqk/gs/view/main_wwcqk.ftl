...
<h2><span class="title tab_wwcqk">信息共享未完成情况(公司)指标统计</span><span class="more"></span></h2>
...
{
	page_load_table("${base}/module/pams/gxgl/rep/wwcqk/gs/rep_tab_wwcqk.action", "wwcqk", 0, new Array("internal","reptype"), new Array("${arg.internal}","${arg.reptype}"));
}
