...
<@pub_macros.showheader repname="信息共享未完成情况(个人)指标统计" />
...
<h2><span class="title tab_wwcqk">信息共享未完成情况(个人)指标统计</span><span class="more"></span></h2>
...
{
	page_load_table("${base}/module/pams/gxgl/rep/wwcqk/ry/rep_tab_wwcqk.action", "wwcqk", 0, new Array("internal","reptype"), new Array("${arg.internal}","${arg.reptype}"));
}
...
function page_query_export()
{
	...
	form_advsearch.action = "${base}/module/pams/gxgl/rep/wwcqk/ry/rep_xls_wwcqk.action";
