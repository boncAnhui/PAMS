...
<tr>
<td>${afbzs_index+1}</td>
<td><a href="${base}/module/pams/gxgl/rep/wcqk/ry/rep_main_wcqk.action?internal=${afbzs.internal}&begindate=${arg.begindate}&enddate=${arg.enddate}" target="_blank">${afbzs.cname}</a></td>
<td>${afbzs.num}</td>
<td>${azcfbzs.num}</td>
<td>${azcfbjdzs.num}</td>
<td>${acsfbjdzs.num}</td>
