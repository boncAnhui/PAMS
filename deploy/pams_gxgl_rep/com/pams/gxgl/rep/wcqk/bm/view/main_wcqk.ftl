...
<@pub_macros.showheader repname="信息共享完成情况(部门)指标统计" />
...
<h2><span class="title tab_wcqk">信息共享完成情况(部门)指标统计</span><span class="more"></span></h2>
...
function page_query_export()
{
	...
	form_advsearch.action = "${base}/module/pams/gxgl/rep/wcqk/bm/rep_xls_wcqk.action";
