...
<tr>
<td>${aobj_index+1}</td>
<td><a href="${base}/module/pams/gxgl/rep/zxqk/gxd/rep_main_zxqk_yfqzs.action?ownerctx=${aobj.loginname}&begindate=${arg.begindate}&enddate=${arg.enddate}">${aobj.username}</a></td>
