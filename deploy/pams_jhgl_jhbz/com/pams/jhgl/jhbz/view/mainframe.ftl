...
<ul id="gAjaxTree">
	...
	<span class="root">共享申请</span>
		<ul>
		<li data-pid="main" data-index="21" data-parent="" data-leaf="0" data-id="jhgl_browsecreate" data-url="${base}/module/pams/jhgl/jhbz/apply_browsecreate.action?_searchname=jhgl.jhbz.browsecreate&flowcclass=GXGL">
		<span class="folder">岗位编制的计划</span>
		</li>
		<li data-pid="main" data-index="22" data-parent="" data-leaf="0" data-id="jhgl_browsehead" data-url="${base}/module/pams/jhgl/jhbz/apply_browsehead.action?_searchname=jhgl.jhbz.browsehead&flowcclass=GXGL">
		<span class="folder">岗位负责的计划</span>
		</li>
		<li data-pid="main" data-index="23" data-parent="" data-leaf="0" data-id="jhgl_browsehead" data-url="${base}/module/pams/jhgl/jhbz/apply_browsehead.action?_searchname=jhgl.jhbz.browsehead&flowcclass=GXGL">
		<span class="folder">岗位主管的计划</span>
		</li>		
		<li data-pid="main" data-index="24" data-parent="" data-leaf="0" data-id="jhgl_browseall" data-url="${base}/module/pams/jhgl/jhbz/apply_browseall.action?_searchname=jhgl.jhbz.browseall&flowcclass=GXGL">
