...
$('#gAjaxTree li span').live('click',function(){
	...
	window.rightIframe.location='${base}/module/pams/ypsj/gxwh/apply_selectscopeuser.action?organid='+obj.attr('data-id');	
...
function page_save()
{
	...
	{
		opener.find('#marketpowerscopeinternal').val(v_marketpowerscopeinternal + "," + octypes);	
	}
	else
	{
