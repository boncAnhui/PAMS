...
<div id="pageContainer" style="display:inline-block;">
	...
	<tr>
		...
		<td colspan="3">
		<input type="hidden" id="marketpowerscopeid" name="marketpowerscopeid" value="${data.defsharescopeid}">
		<input type="hidden" id="marketpowerscopectype" name="marketpowerscopectype" value="${data.defsharescopectype}">
		<input type="hidden" id="marketpowerscopeinternal" name="marketpowerscopeinternal" value="${data.defsharescopeinternal}">
		<input class="text" readonly id="marketpowerscope" name="marketpowerscope" style="width:45em" value="${data.defsharescope}"/>
