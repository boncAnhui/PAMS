...
<table class="formGrid">
	<tr>
		...
		<input readonly class="select required" id="selectpositionname" data-options="${data.userrole_texts}" data-values="${data.userrole_values}" data-default="${data.marketpower.positionname}">
		</span>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input class="text required" id="cclassname" name="cclassname" style="width:20em" value="${data.marketpower.cclassname}"/></td>
		<#--
	...
	<tr>
		...
		<td colspan="3">
		<input type="hidden" id="marketpowerscopeid" name="marketpowerscopeid">
		<input type="hidden" id="marketpowerscopectype" name="marketpowerscopectype">
	...
	<tr>
		...
		<ul class="attachmentUl">
			...
			<a target="_blank" class="attachment" href="${base}/module/pams/ypsj/wjwh/fileattachment_downloadbyid.action?id=${afile.id}">【${afile.sfilename}】</a>&nbsp;&nbsp;${afile.creatername}&nbsp;于&nbsp;${afile.createtime}&nbsp;在&nbsp; ${afile.actname}&nbsp;业务环节上传。<br>
			</li>
			</#list>
		</ul>
		</td>
