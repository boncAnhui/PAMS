...
$('.topTr li').click(function(){
	...
	if(oindex==1){ // 基本信息
		...
		oFrame.attr('src','${base}/module/irm/system/flow/opinion/opinion_browse.action?runflowkey=${arg.runflowkey}');
	}else if(oindex==3){ // 流程跟踪
		oFrame.attr('src','${base}/module/app/system/workflow/ui/flowtrace.action?runactkey=${arg.runactkey}&tableid=MarketPower');
...
<tr class="bottomTr">
<td>
	<iframe src="apply_readpage.action?runactkey=${arg.runactkey}" frameborder="0"></iframe>
</td>
</tr>
