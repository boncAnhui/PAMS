...
<ul id="gAjaxTree">
	...
	<span class="root">共享申请</span>
		<ul>
		<li data-pid="main" data-index="21" data-parent="" data-leaf="0" data-id="ypsj_browsewait" data-url="${base}/module/pams/ypsj/gxwh/apply_browsewait.action?_searchname=ypsj.gxwh.browsewait&flowcclass=YPSJ">
		<span class="folder">岗位待办工作</span>
		</li>
		<li data-pid="main" data-index="22" data-parent="" data-leaf="0" data-id="ypsj_browsehandle" data-url="${base}/module/pams/ypsj/gxwh/apply_browsehandle.action?_searchname=ypsj.gxwh.browsehandle&flowcclass=YPSJ">
		<span class="folder">岗位已办工作</span>
		</li>
		<li data-pid="main" data-index="23" data-parent="" data-leaf="0" data-id="ypsj_browseall" data-url="${base}/module/pams/ypsj/gxwh/apply_browseall.action?_searchname=ypsj.gxwh.browseall&flowcclass=YPSJ">
		<span class="folder">岗位所有工作</span>
		</li>
		<li data-pid="main" data-index="24" data-parent="" data-leaf="0" data-id="ypsj_browsegroupall" data-url="${base}/module/pams/ypsj/gxwh/apply_browsegroupall.action?_searchname=ypsj.gxwh.browsegroupall&flowcclass=YPSJ">
