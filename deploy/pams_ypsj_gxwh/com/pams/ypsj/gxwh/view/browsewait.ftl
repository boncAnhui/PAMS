...
function page_input()
{
	url = "${base}/module/pams/ypsj/gxwh/apply_input.action?_searchname=pams.ypsj.gxwh.input";
...
function page_del()
{
	...
	{
		window.location = "${base}/module/pams/ypsj/gxwh/apply_delete.action?runactkeys=" + oids;
	}
}
