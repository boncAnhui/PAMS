...
<ul id="gAjaxTree">
	...
	<span class="folder">信息收集</span>
		...
		<li data-pid="main" data-index="22" data-parent="" data-leaf="0" data-id="xxsj_browsehandle" data-url="">
		<span class="folder">已办工作</span>
		</li>
		<li data-pid="main" data-index="23" data-parent="" data-leaf="0" data-id="xxsj_browsegroupsall" data-url="">
		<span class="folder">全部工作</span>
		</li>
		</ul>
	...
	<span class="folder">用户申请</span>
		...
		<li data-pid="main" data-index="21" data-parent="" data-leaf="0" data-id="yhsq_browsewait" data-url="${base}/module/pams/hbgl/yhsq/apply_browsehandle.action?_searchname=hbgl.yhsq.browsehandle&flowsno=HBGL_YHSQ">
		<span class="folder">待办工作</span>
		</li>
