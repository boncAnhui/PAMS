...
<div id="pageContent"><div id="chartDivs">
	...
	<h2><span class="title tab_yjya_ywgl">后续相关业务统计表</span><span class="more"></span></h2>
	<div class="p8" id="tab_yjya_ywgl">
	</div>
	</div>
	
	<div class="section sec2">
	<h2><span class="title rep_yjya_ywgl">后续相关业务统计图</span><span class="more"></span></h2>
	<div class="p8" id="rep_yjya_ywgl">
	</div>
...
function page_load_gjywld_table(type)
{
	if(type == 'yyxt')
	{
		page_load_table("${base}/module/app/report/deepen/yjya/ywld/report_tab_yyxt_yjywld.action", "yjya_ywgl",0, "", "");
	}
	else if(type == 'fyyxt')
	{
		page_load_table("${base}/module/app/report/deepen/yjya/ywld/report_tab_yjywld.action", "yjya_ywgl",0, "", "");
	}
	else if(type == 'all')
	{
		page_load_table("${base}/module/app/report/deepen/yjya/ywld/report_tab_all_yjywld.action", "yjya_ywgl",0, "", "");
	}
}
...
function page_load_gjywld_chart(type)
{
	if(type == 'yyxt')
	{
		page_load_chart("yjya.ywld", "yjya_ywgl", 0, "Pie3D", new Array("type"), new Array("yyxt"));
	}
	else if(type == 'fyyxt')
	{
		page_load_chart("yjya.ywld", "yjya_ywgl", 0, "Pie3D", new Array("type"), new Array("fyyxt"));
	}
	else if(type == 'all')
	{
		page_load_chart("yjya.ywld", "yjya_ywgl", 0, "Pie3D", new Array("type"), new Array("all"));
	}
}
