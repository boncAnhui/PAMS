...
<div id="pageContent"><div id="chartDivs">
	...
	<h2><span class="title rep_maintenance_jxnqs">检修年总量趋势图</span><span class="more"></span></h2>
	<div class="p8" id="rep_maintenance_jxnqs">
	</div>
	
	<div class="section sec2 sLeft">
	<h2><span class="title tab_maintenance_jxlx">计划检修按类型统计表</span><span class="more"></span></h2>
	<div class="p8" id="tab_maintenance_jxlx">
	</div>
	</div>
	
	<div class="section sec3 sLeft">
	<h2><span class="title tab_maintenance_jxjg">计划检修结果统计表</span><span class="more"></span></h2>
	<div class="p8" id="tab_maintenance_jxjg">
	</div>
	</div>
...
<script>
function page_load_jxnqs_chart()
{
	...
	page_load_chart("deepen.maintenance.jxnqs", "maintenance_jxnqs", 0, "MSLine", new Array("bbegindate","benddate"), new Array(bbegindate,benddate));

}

function page_load_jxlx_table()
{
	page_load_table("${base}/module/app/report/deepen/maintenance/jxlx/report_tab_yyxt_jxlx.action", "maintenance_jxlx",0, "", "");
}

function page_load_jxjg_table()
{
	page_load_table("${base}/module/app/report/deepen/maintenance/result/report_tab_yyxt_jxjg.action", "maintenance_jxjg",0, "", "");
}

function page_query()
{
	page_load_jxnqs_chart();
	page_load_jxlx_table();
	page_load_jxjg_table();
}
function page_load()
{
	page_load_jxnqs_chart();
