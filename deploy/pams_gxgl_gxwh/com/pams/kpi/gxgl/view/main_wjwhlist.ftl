...
<@pub_macros.showheader repname="文件共享单数量指标统计" />

<#include "/com/ray/nwpn/itsm/report/common/view/nav.ftl">

<br />
<div class="section sec1">
<h2><span class="title tab_wjwhlist">文件共享单数量指标统计</span><span class="more"></span></h2>
<div class="p8" id="tab_wjwhlist">
</div>
</div>
...
{
	page_load_table("${base}/module/pams/kpi/gxgl/kpi_kpi_wjwhlist.action", "wjwhlist", 0, new Array("creater"), new Array('${arg.creater}'));
}
