...
<h2><span class="title tab_zxscmx">文件共享单数量指标统计</span><span class="more"></span></h2>
...
{
	page_load_table("${base}/module/pams/kpi/gxgl/kpi_kpi_zxscmx.action", "zxscmx", 0, new Array("ownerctx"), new Array("${arg.ownerctx}"));
}
