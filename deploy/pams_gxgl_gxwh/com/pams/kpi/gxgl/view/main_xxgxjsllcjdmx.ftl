...
<h2><span class="title tab_xxgxjsllcjdmx">信息共享及时率指标统计（流程节点明细统计）</span><span class="more"></span></h2>
<div class="p8" id="tab_xxgxjsllcjdmx">
</div>
</div>
...
{
	page_load_table("${base}/module/pams/kpi/gxgl/kpi_kpi_xxgxjsllcjdmx.action", "xxgxjsllcjdmx", 0, new Array("cno"), new Array("${arg.cno}"));
}
