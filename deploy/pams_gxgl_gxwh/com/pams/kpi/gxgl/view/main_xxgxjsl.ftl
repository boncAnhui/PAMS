...
<h2><span class="title tab_xxgxjsl">信息共享执行时长指标统计</span><span class="more"></span></h2>
<div class="p8" id="tab_xxgxjsl">
</div>
</div>
...
{
	page_load_table("${base}/module/pams/kpi/gxgl/kpi_kpi_xxgxjsl.action", "xxgxjsl", 0, new Array(), new Array());
}
