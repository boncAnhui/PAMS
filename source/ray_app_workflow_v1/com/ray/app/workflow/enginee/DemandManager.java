...
//		}
	...
	public List getActionOwnerToPerson(String actdefid) throws java.lang.Exception
	{
		...
		sqlBuf.append(" ( ");
		sqlBuf.append("select distinct b.userid ownerctx, c.name cname, 'PERSON' ctype \n");
		...
		sqlBuf.append(" union \n");
		sqlBuf.append("select a.ownerctx, c.name cname, a.ctype \n");
		...
		sqlBuf.append("   and a.actid = " + SQLParser.charValueRT(actdefid));
		sqlBuf.append("   order by cname ");
		sqlBuf.append("   ) \n");

		sqlBuf.append("select ownerctx, cname, ctype from temp \n");
