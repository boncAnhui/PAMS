...
<div id="pageContent"><div id="chartDivs">
	...
	<h2><span class="title tab_audit_xjywgl">后续相关业务统计表</span><span class="more"></span></h2>
	<div class="p8" id="tab_audit_xjywgl">
	</div>
	</div>
	
	<div class="section sec2">
	<h2><span class="title rep_audit_xjywgl">后续相关业务统计图</span><span class="more"></span></h2>
	<div class="p8" id="rep_audit_xjywgl">
	</div>
...
<script>
var ctype = '${data.type}';
function page_load_xjywld_table(type)
{
	if(type == 'yyxt')
	{
		page_load_table("${base}/module/app/report/deepen/audit/ywld/report_tab_yyxt_xjywld.action", "audit_xjywgl",0, "", "");
	}
	else if(type == 'fyyxt')
	{
		page_load_table("${base}/module/app/report/deepen/audit/ywld/report_tab_xjywld.action", "audit_xjywgl",0, "", "");
	}
	else if(type == 'all')
	{
		page_load_table("${base}/module/app/report/deepen/audit/ywld/report_tab_all_xjywld.action", "audit_xjywgl",0, "", "");
	}
}

function page_load_xjywld_chart(type)
{
	if(type == 'yyxt')
	{
		page_load_chart("audit.ywld", "audit_xjywgl", 0, "Pie3D", new Array("type"), new Array("yyxt"));
	}
	else if(type == 'fyyxt')
	{
		page_load_chart("audit.ywld", "audit_xjywgl", 0, "Pie3D", new Array("type"), new Array("fyyxt"));
	}
	else if(type == 'all')
	{
		page_load_chart("audit.ywld", "audit_xjywgl", 0, "Pie3D", new Array("type"), new Array("all"));
	}
}
...
{
	ctype = type;
	page_load_xjywld_table(ctype);
	page_load_xjywld_chart(ctype);
}
function page_load()
{
	page_load_xjywld_table(ctype);
